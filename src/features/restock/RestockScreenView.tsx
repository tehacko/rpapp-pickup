...
export function RestockScreenView({
  ...
  const showOfflineBanner = viewModel.offlineApplyBlocked;
  const showStatusBanner = viewModel.statusMessage !== null;
  const hasBanners = showOfflineBanner || showStatusBanner;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="grid grid-cols-1 items-start gap-[var(--pickup-stack-gap)] lg:grid-cols-[minmax(0,1fr)_minmax(20rem,26rem)]"
